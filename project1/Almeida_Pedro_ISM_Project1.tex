...
Using the deflection equation, the report finds the maximum displacement occurs at $x = 5.8959 m$, which has a downward displacement of $6.3530/EI$ as shown in Fig. \ref{prob1:results}. Given the maximum displacement allowed $v_a = L/500$, or 0.02 meters, and a maximum yield stress of 276 MPa, the report uses Eq. \ref{problem1_beam_geo} and a safety factor $k=1.5$ to find the required Moment of Inertia $I$ of the beam. As such, the W250 X 32.7 I-Beam would satisfy both the strength and stiffness requirements.

\begin{equation}
\begin{split}
& I < \frac{v_{max}}{Ev_a} \\
& I < 4.544\,{mm}^2 \\
& A > \frac{F_{max}}{\sigma_{allowed}} = \frac{F_{max}}{\sigma_Y k}\\
& A > 2.657\,{mm}^2 \\
\end{split}
...
\centering
   ...
   \centering
   \includegraphics[width=0.8\textwidth]{problems/prob_1.jpg}
...
\begin{subfigure}[b]{\textwidth}
   \centering   
   \includegraphics[width=0.8\textwidth]{results/solution_1.jpg}
