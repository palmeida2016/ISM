...
& - 12\left<x-5\right>^0 -  35\left<x-6\right>^2 + 35\left<x-8\right>^2  - \frac{2}{3}\left<x-9\right>^3 \\
& \\
...
& -  \frac{35}{3}\left<x-6\right>^3 + \frac{35}{3}\left<x-8\right>^3  - \frac{1}{6}\left<x-9\right>^4 + C_1 \\
& \\
...
& - 6\left<x-5\right>^2 -  \frac{35}{12}\left<x-6\right>^4 + \frac{35}{12}\left<x-8\right>^4  - \frac{1}{30}\left<x-9\right>^5 + C_1x + C_2 \\ \\
    \end{split}
\label{problem1_equations}
\end{equation}
